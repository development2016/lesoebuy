...
<div class="row">
        ...
        <div class="col-lg-4">
            ...
            <?= $form->field($model, 'sellers[warehouses][person_in_charge]')->textInput(['id'=>'person_in_charge','value'=>$model['sellers'][0]['warehouses'][0]['person_in_charge']])->label('Person In Charge') ?>
