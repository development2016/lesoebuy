...
<div class="ecommerce-form">
    ...
    <?php foreach ($data as $key => $value) { ?>
		...
		<div class="form-group field-project-sellers-0-items-0-installation_price">
		  ...
		  <input type="text" id="project-sellers-0-items-0-installation_price" class="form-control" name="Project[sellers][0][installation_price]" value="<?php echo $value['sellers'][0]['installation_price']; ?>">
