                ...
                <div class="btn-group pull-right">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        <?= Html::a('Save to Item',FALSE, ['value'=>Url::to([
                            ...
                            'path' => 'revise',
                            'approver'=>$list[0]['sellers'][0]['approver'],
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="row static-info">
                        ...
                        <div class="col-md-6"> <h4 class="bold">
                    <?php echo $list[0]['sellers'][0]['purchase_order_no']; ?><?php echo $list[0]['sellers'][0]['purchase_order_no_revise'] ?>
                        </h4></div>
                    </div>
                    <div class="row static-info">
