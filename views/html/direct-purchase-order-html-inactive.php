            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="row static-info">
                        ...
                        <div class="col-md-7"> <h4 class="bold"><b><?= $list[0]['sellers']['purchase_order_no'] ?></b></h4></div>
                    </div>
                    <div class="row static-info">
                        <div class="col-md-5"> <h4 class="bold">Date : </h4></div>
                        <div class="col-md-7"> <h4><?php echo $new = date('d F Y', strtotime($list[0]['sellers']['date_purchase_order'])); ?></h4></div>
                    </div>
                    <div class="row static-info">
