            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="row static-info">
                        ...
                        <div class="col-md-7"> 
                                    <?php if (empty($list[0]['sellers']['warehouses'])) { ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <h4>
                                            <?= $list[0]['sellers']['warehouses'][0]['warehouse_name'] ?>
                                            <br>
                                            <?= $list[0]['sellers']['warehouses'][0]['address'] ?>,
                                        <?php if (empty($list[0]['sellers']['warehouses'][0]['postcode']) || !isset($list[0]['sellers']['warehouses'][0]['postcode'])) {
                                            
                                            
                                        } else {

                                            echo $list[0]['sellers']['warehouses'][0]['postcode'];
                                        }
                                        ...
                                        <?php 
                                        $country_da = LookupCountry::find()->where(['id'=>$list[0]['sellers']['warehouses'][0]['country']])->one();
                                        $state_da = LookupState::find()->where(['id'=>$list[0]['sellers']['warehouses'][0]['state']])->one();
                                        ?>
                                        <?= $state_da->state; ?>,
                                        <?= $country_da->country; ?>

                                            <br>
                                            <b>P.I.C : </b> <?= $list[0]['sellers']['warehouses'][0]['person_in_charge'] ?>
                                            <br>
                                            <b>Contact : </b> : <?= $list[0]['sellers']['warehouses'][0]['contact'] ?>
                                            <br>
                                        <?php if (empty($list[0]['sellers']['warehouses'][0]['fax']) || !isset($list[0]['sellers']['warehouses'][0]['fax'])) { ?>
                                            
                                            <b>Fax : </b>
                                            <br>
                                        <?php } else { ?>

                                            <b>Fax : </b><?= $list[0]['sellers']['warehouses'][0]['fax'] ?>
                                            <br>
                                        <?php } ?>


                                            <b>Email : </b><?= $list[0]['sellers']['warehouses'][0]['email'] ?>
                                        </h4>
                ...
                <div class="col-md-3">
                    <div class="row static-info">
                        ...
                        <div class="col-md-7"> <h4 class="bold"><b><?= $list[0]['sellers']['purchase_requisition_no'] ?></b></h4></div>
                    </div>
                    <div class="row static-info">
                        <div class="col-md-5"> <h4 class="bold">Date : </h4></div>
                        <div class="col-md-7"> <h4><?php echo $new = date('d F Y', strtotime($list[0]['sellers']['date_purchase_requisition'])); ?></h4></div>
                    </div>
                    <div class="row static-info">
                        <div class="col-md-5"> <h4 class="bold">Term : </h4></div>
                        <div class="col-md-7"> <h4><?= $list[0]['sellers']['term'] ?></h4></div>
                    </div>
                    <div class="row static-info">
                        <div class="col-md-5"> <h4 class="bold">Delivery Before : </h4></div>
                        <div class="col-md-7"> <h4>
                            <?php if (empty($list[0]['sellers']['delivery_before'])) { ?>

                            <?php } else { ?>
                                <?php echo $new = date('d F Y', strtotime($list[0]['sellers']['delivery_before'])); ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php $arrayItem = -1; $i=0; foreach ($list[0]['sellers']['items'] as $key => $value) { $i++; $arrayItem++; ?>
                                <tr>
                                    <td>
                                        <h4><span><?= $i; ?></span></h4>
                                    </td>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php 
                               ...
                               $deductGst = $total * ($list[0]['sellers']['tax'] / 100 );

                                
                        ?>
                        <h4>
                            <span><?= $list[0]['sellers']['tax']; ?>% 
                            <?= empty($list[0]['sellers']['type_of_tax']) ? '(Empty Type Of Tax)' : $list[0]['sellers']['type_of_tax'] ; ?> : </span> <span class="pull-right font-red-sunglo bold">
                        ...
                        <br>
                        <h3>
                            <span><b>Total</b> (<?= $list[0]['sellers']['tax']; ?>% <?= empty($list[0]['sellers']['type_of_tax']) ? '(Empty Type Of Tax)' : $list[0]['sellers']['type_of_tax'] ; ?>) : </span> <span class="pull-right bold">
                                <?php
